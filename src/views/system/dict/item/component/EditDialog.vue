      ...
      <el-row :gutter="35">
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
          <el-form-item label="字典项名称" prop="dictLabel">
            <el-input v-model="ruleForm.dictLabel" placeholder="请输入字典项名称" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
          <el-form-item label="字典项值" prop="dictValue">
            <el-input v-model="ruleForm.dictValue" placeholder="请输入字典项值" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
          <el-form-item label="字典顺序" prop="sortNo">
            <el-input-number v-model="ruleForm.sortNo" placeholder="请输入字典顺序" clearable></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb-2">
          <el-form-item label="字典项备注">
            <el-input v-model="ruleForm.remark" type="textarea" placeholder="请输入字典项备注" maxlength="150"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
