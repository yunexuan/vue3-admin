      ...
      <el-row :gutter="35">
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
          <el-form-item label="字典名称" prop="dictName">
            <el-input v-model="ruleForm.dictName" placeholder="请输入字典名称" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-2">
          <el-form-item label="字典标识" prop="dictType">
            <el-input v-model="ruleForm.dictType" placeholder="请输入字典标识" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb-2">
          <el-form-item label="字典备注">
            <el-input v-model="ruleForm.remark" type="textarea" placeholder="请输入字典备注" maxlength="150"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
