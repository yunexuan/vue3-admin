  ...
  <div class="table-box">
    <ProTable ref="proTable" :columns="columns" :request-api="getTableList" :init-param="initParam" :data-callback="dataCallback">
      ...
      <template #operation="scope">
        <DropdownMenu>
          <el-button type="primary" link icon="i-ep-edit" @click="handleEdit(scope.row)">
            编辑
          </el-button>
          <el-button type="primary" link icon="i-ep-refresh" @click="resetPass(scope.row)">
            重置密码
          </el-button>
          <el-button type="primary" link icon="i-ep-delete" @click="deleteAccount(scope.row)">
            删除
          </el-button>
        </DropdownMenu>
      </template>
