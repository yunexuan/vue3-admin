      ...
      <el-row :gutter="35">
        ...
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
          <el-form-item label="菜单名称" prop="menuName">
            <el-input v-model="ruleForm.menuName" placeholder="请输入菜单名称" clearable />
          </el-form-item>
        </el-col>
        <template v-if="ruleForm.menuType === 0">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item label="路由路径" prop="menuPath">
              <el-input v-model="ruleForm.menuPath" placeholder="路由中的 path 值" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item label="页面路径" prop="pagePath">
              <el-input v-model="ruleForm.pagePath" placeholder="路由中的 path 值" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item label="重定向" prop="redirectPath">
              <el-input v-model="ruleForm.redirectPath" placeholder="请输入重定向路由" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item label="菜单图标" prop="menuIcon">
              <SelectIcon v-model:icon-value="ruleForm.menuIcon" placeholder="请选择菜单图标" />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb10">
            <el-form-item label="权限标识" prop="authority">
              <el-input v-model="ruleForm.authority" placeholder="请输入权限标识" clearable />
            </el-form-item>
          </el-col>
