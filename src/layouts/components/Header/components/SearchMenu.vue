...
<template>
  <div class="search-menu">
    <i class="iconfont icon-sousuo toolBar-icon" @click="handleOpen" />
    <el-dialog v-model="isShowSearch" class="search-dialog" :width="600" :show-close="false" top="10vh">
      ...
      <div v-if="searchList.length" ref="menuListRef" class="menu-list">
        ...
        >
          ...
          <i class="iconfont icon-huiche menu-enter" @click="handleOpen" />
        </div>
      </div>
      <el-empty v-else class="mb20 mt20" :image-size="100" description="暂无菜单" />
    </el-dialog>
  </div>
</template>
